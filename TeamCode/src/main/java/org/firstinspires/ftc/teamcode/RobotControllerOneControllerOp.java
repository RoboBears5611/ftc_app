...
@TeleOp(name = "Robot Controller (One Controller)",group = "drive")
public class RobotControllerOneControllerOp extends OpMode {
...
//    DcMotor ResettingMotor;
    ...
    public void loop(){
        ...
        controls.grabberToggleVariableControl = gamepad1.b;
        controls.grabberToggleOpenClosed = gamepad1.right_bumper;
